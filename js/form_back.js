		...
		if ( isFormValid == true ) {
			...
			$('#order-2-1').ajaxComplete(function(){
             ...
             //   addToBasket($(this).serializeArray());
				...
				$('#znach_order_head-2-1').text('Товар добавлен в корзину!');
			});
			}
	});	*/
	...
	/*$('#order-2-2').bind('submit', function(con) {
		...
		if ( isFormValid == true ) {
			...
			$('#order-2-2').ajaxComplete(function(){
				...
				$('#znach_order_head-2-2').text('Товар добавлен в корзину!');
			});
			}
	});	*/
	...
	/*$('#order-2-3').bind('submit', function(con) {
		...
		if ( isFormValid == true ) {
			...
			$('#order-2-3').ajaxComplete(function(){
				...
				$('#znach_order_head-2-3').text('Товар добавлен в корзину!');
			});
			}
	});	*/
	...
	/*$('#order-2-4').bind('submit', function(con) {
		...
		if ( isFormValid == true ) {
			...
			$(this).ajaxComplete(function(){
				...
				$('.znach_order_head').text('Товар добавлен в корзину!');
	...
	/*$('#order-2-5').bind('submit', function(con) {
		...
		if ( isFormValid == true ) {
			...
			$('#order-2-5').ajaxComplete(function(){
				...
				$('#znach_order_head-2-5').text('Товар добавлен в корзину!');
			});
			}
	});	*/
	...
	/*$('#order-2-6').bind('submit', function(con) {
		...
		if ( isFormValid == true ) {
			...
			$('#order-2-6').ajaxComplete(function(){
				...
				$('#znach_order_head-2-6').text('Товар добавлен в корзину');
			});
			}
	});	*/
